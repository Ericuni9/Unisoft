            ...
            <div class="card dadclient">
                ...
                <div class="tab-pane fade" id="Servicos" role="tabpanel" aria-labelledby="Servicos-tab">
                    <div class="container">
                        ...
                        <div class="card-deck">
                            @forelse ($user->servicos as $servico)
                            <div class="card">
                                <div class="card-header">{{ ucfirst(mb_strtolower($servico->title)) }}</div>
                                    <div class="card-body">
                            ...
                            @empty
                                <div class="card">
                                    <div class="card-body">
                                        <p class="card-text">Ainda não há serviços contratados</p>
                                    </div>
                                </div>
                            @endforelse
                        </div>
                ...
                <div class="tab-pane fade" id="Produtos" role="tabpanel" aria-labelledby="Produtos-tab">
                    <div class="container">
                        ...
                        @forelse($user->produtos as $produto)
                        <div class="card-deck">
                            <div class="card">
                        ...
                        <div class="card-deck">
                            <div class='card'>
                                <div class="card-body">
                                    <p class='card-text'>Ainda não há produtos contratados</p>
                                </div>
                            </div>
                        @endforelse
                    </div>
